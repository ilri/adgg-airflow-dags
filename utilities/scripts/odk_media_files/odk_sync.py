...
BASE_FILE_PATH = os.path.dirname(current_file_path) + '/media_files/'
...
stored_procs = {
    ...
    "registered_ai_bulls_lists": (9, DB_NAME),
...
def main():
    ...
    file_names = ['animal_list.zip', 'farmer_list.zip', 'farmer_list_extended.zip', 'lactation.zip',
                  'region_list.zip', 'zone_list.zip', 'ward_list.zip', 'village_list.zip', 'registered_ai_bulls_lists.zip' , 'form_controller.zip','staff_list.zip','staff_rights.zip']
